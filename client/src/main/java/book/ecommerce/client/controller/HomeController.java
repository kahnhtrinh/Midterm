...
import book.ecommerce.library.model.Dropdown;
...
public class HomeController {
    ...
    public List<Dropdown> getModels(@RequestParam Long make) {
        List<book.ecommerce.library.model.Model> modelList = modelService.getModels(make);
        List<Dropdown> dropdownList=new ArrayList<>();
        for (book.ecommerce.library.model.Model model: modelList) {
