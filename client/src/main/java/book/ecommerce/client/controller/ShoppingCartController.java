...
import book.ecommerce.client.config.VNPayConfig;
import book.ecommerce.client.dto.PaymentInfoDTO;
import book.ecommerce.library.model.*;
import book.ecommerce.library.service.*;
...
//        emailService.orderCreation(appUrl, newOrder);
        ...
        if (shoppingCart.getPaymentMethod().equals("VNPay")) {
            ...
            vnp_Params.put("vnp_Amount", String.valueOf(shoppingCart1.getGrandTotal().intValue() * 1000000));
